  ...
  return {
    ...
    each: function (a, d, f) {
      if (e && a.forEach === e) a.forEach(d, f);
        ...
        for (
          var c = 0, p = a.length;
          c < p && !(c in a && d.call(f, a[c], c) === this.BREAK);
          c++
        );
      else for (c in a) if (d.call(f, a[c], c) === this.BREAK) break;
    },
    defer: function (a) {
      setTimeout(a, 0);
    },
  ...
  var d = /(\d+(\.\d+)?)px/,
    f = {
      makeSelectable: function (c, a) {
        void 0 !== c &&
          ...
          ((c.onselectstart = a
            ...
            : function () {}),
          (c.style.MozUserSelect = a ? "auto" : "none"),
          (c.style.KhtmlUserSelect = a ? "auto" : "none"),
          (c.unselectable = a ? "on" : "off"));
      },
      ...
      getWidth: function (c) {
        ...
        return (
          a(c["border-left-width"]) +
          a(c["border-right-width"]) +
          a(c["padding-left"]) +
          a(c["padding-right"]) +
          a(c.width)
        );
      ...
      getHeight: function (c) {
        c = getComputedStyle(c);
        return (
          a(c["border-top-width"]) +
          a(c["border-bottom-width"]) +
          a(c["padding-top"]) +
          a(c["padding-bottom"]) +
          a(c.height)
        );
...
dat.controllers.NumberControllerBox = (function (e, a, b) {
  ...
  b.extend(d.prototype, e.prototype, {
    updateDisplay: function () {
      var a = this.__input,
        c;
      if (this.__truncationSuspended) c = this.getValue();
      else {
        c = this.getValue();
    ...
    f = [
      ...
      },
      {
        ...
        conversions: {
          RGBA_OBJ: {
            read: function (c) {
              return a.isNumber(c.r) &&
                ...
                a.isNumber(c.b) &&
                a.isNumber(c.a)
                ? { space: "RGB", r: c.r, g: c.g, b: c.b, a: c.a }
                : !1;
            },
            write: function (a) {
          ...
          HSVA_OBJ: {
            read: function (c) {
              return a.isNumber(c.h) &&
                a.isNumber(c.s) &&
                a.isNumber(c.v) &&
                a.isNumber(c.a)
                ? { space: "HSV", h: c.h, s: c.s, v: c.v, a: c.a }
                : !1;
            },
            write: function (a) {
...
dat.GUI = dat.gui.GUI = (function (
  ...
  function t(a, c, b, e) {
    ...
    e.color
      ? (c = new n(c, b))
      : ((c = [c, b].concat(e.factoryArgs)), (c = d.apply(a, c)));
  ...
  function s(a, d, b) {
    ...
    if (b instanceof l) {
      ...
      var f = function (d) {
        return h.isNumber(b.__min) && h.isNumber(b.__max)
          ? (b.remove(),
            t(a, b.object, b.property, {
              before: b.__li.nextElementSibling,
      ...
      b instanceof c
        ...
        : b instanceof p
          ...
          : b instanceof n &&
            (g.addClass(d, "color"),
            (b.updateDisplay = h.compose(function (a) {
  ...
  function v(a, d) {
    ...
    if (-1 != c) {
      ...
      void 0 === e &&
        ((e = {}), (b.__rememberedObjectIndecesToControllers[c] = e));
      e[d.property] = d;
      if (b.load && b.load.remembered) {
        ...
        b[c] &&
          void 0 !== b[c][d.property] &&
          ((c = b[c][d.property]), (d.initialValue = c), d.setValue(c));
      }
    }
  }
  function K(a) {
    ...
    a.load && a.load.remembered
      ? h.each(a.load.remembered, function (b, d) {
          E(a, d, d == a.preset);
        })
      : E(a, z, !1);
  ...
  var z = "Default",
    w;
  try {
    w = "localStorage" in window && window.localStorage;
  } catch (M) {
    w = !1;
  }
  var A,
    ...
    m = function (a) {
      ...
      a.autoPlace &&
        (h.isUndefined(a.parent) &&
          (H &&
            ((x = document.createElement("div")),
            g.addClass(x, "dg"),
            g.addClass(x, m.CLASS_AUTO_PLACE_CONTAINER),
            document.body.appendChild(x),
            (H = !1)),
          x.appendChild(this.domElement),
          g.addClass(this.domElement, m.CLASS_AUTO_PLACE)),
        this.parent || F(c, a.width));
  ...
  h.extend(m.prototype, {
    ...
    saveAs: function (a) {
      this.load.remembered ||
        ((this.load.remembered = {}), (this.load.remembered[z] = B(this, !0)));
  ...
  (dat.controllers.factory = (function (e, a, b, d, f, c, p) {
    return function (k, l, q, n) {
      ...
      if (p.isNumber(r))
        return p.isNumber(q) && p.isNumber(n)
          ? new b(k, l, q, n)
          : new a(k, l, { min: q, max: n });
    ...
    (dat.controllers.StringController = (function (e, a, b) {
      var d = function (b, c) {
        function e() {
  ...
  (dat.controllers.ColorController = (function (e, a, b, d, f) {
    ...
    var k = function (e, n) {
      ...
      function g() {
        var a = d(this.value);
        !1 !== a
          ? ((s.__color.__state = a), s.setValue(s.__color.toOriginal()))
      ...
      f.extend(v.style, { width: "100%", height: "100%", background: "none" });
    ...
    f.extend(k.prototype, e.prototype, {
      updateDisplay: function () {
        ...
        f.extend(this.__field_knob.style, {
          ...
          border:
            this.__field_knob_border + "rgb(" + k + "," + k + "," + k + ")",
        });
        ...
        f.extend(this.__input.style, {
          ...
          color: "rgb(" + k + "," + k + "," + k + ")",
          textShadow:
            this.__input_textShadow + "rgba(" + l + "," + l + "," + l + ",.7)",
        });
      },
    });
    ...
    dat.controllers.Controller,
    dat.dom.dom,
    (dat.color.Color = (function (e, a, b, d) {
      function f(a, b, d) {
        Object.defineProperty(a, b, {
          ...
          set: function (a) {
            "RGB" !== this.__state.space &&
              (p(this, b, d), (this.__state.space = "RGB"));
            this.__state[b] = a;
          },
        });
      }
      ...
      function k(b) {
        ...
        d.isNaN(c.h)
          ? d.isUndefined(b.__state.h) && (b.__state.h = 0)
          : (b.__state.h = c.h);
      }
      var l = function () {
